  ...
  Widget build(BuildContext context) {
    ...
    switch (selectedIndex){
      ...
      case 1:
        page = FavouritesPage();
      default:
        throw UnimplementedError('This page doesnt exist yet');
    }
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Card(
          ...
          elevation: 4, // Adds some shadow effect
          ...
          child: favorites.isEmpty
            ...
            child: ListView.builder(
              shrinkWrap: true, // Makes it fit within the Card
              itemCount: favorites.length,
              itemBuilder: (context, index) {
                final wordPair = favorites[index];
                return ListTile(
                  title: Text(
                    wordPair.asPascalCase, // Converts "hello world" -> "HelloWorld"
